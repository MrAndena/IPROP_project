...
{
  public:
    Time(const NavierStokes& NS)
      : timestep(0),
        time_current(0.0),
        time_end(NS.numerical_parameters.end_time),
        delta_t(NS.numerical_parameters.delta_t),
        output_interval(NS.numerical_parameters.output_interval)
    {
    }
