...
//----------------------------------------------------------------------------------------------------------------------------------------------
template <int dim>
void CompleateProblem<dim>::initialize_potential()
{ 
  // fix the constants
  const double Re = m_data.geometrical_parameters.emitter_radius; // per adesso un singolo valore
...
void CompleateProblem<dim>::solve_homogeneous_poisson()
{
