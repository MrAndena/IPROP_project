...
{
public:
  InsIMEX(parallel::distributed::Triangulation<dim> &tria, const NavierStokes& NS, unsigned short int i);              //We need a parallel::DIstributedTriangulation so our mesh must be in this class or similar to parallelize it
  void run();
